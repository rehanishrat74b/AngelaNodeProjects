...
const uri = "mongodb+srv://rehanishrat74:CiGrTSUnp1pdfyut@clusterrehan.ftufvvt.mongodb.net/?retryWrites=true&w=majority&appName=ClusterRehan";
...
async function run() {
  try {
    ...
    const collectionName = "recipes";  //table name

    // Create references to the database and collection in order to run
    // operations on them.
    const database = client.db(dbName);
    const collection = database.collection(collectionName);  //creating table
